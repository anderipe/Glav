...
class ServicioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $sql = "select s.id , a.modelo , a.matricula ,concat(e.nombre,' ',e.apellido )as empleado ,s.estado_servicio,s.fecha_servicio,s.fecha_entrega, s.observacion,s.pago,r.valor
        from Servicio s inner join Automotor a on a.id=s.id_automotor inner join Empleado e on e.id=s.id_empleado  inner join Rubro r on r.id = s.id_rubro
        where s.estado = 1";
